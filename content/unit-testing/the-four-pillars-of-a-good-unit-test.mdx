...
For more information, read the book used as source for this information: [Unit Testing: Principles, Practices and Patterns](https://www.manning.com/books/unit-testing)
